...
1. When the scope is unclear or broad, offer a compact outline (for example, the likely project structure and the major work items) before writing. Tailor verification to the actual change; add focused tests when they provide meaningful protection. If the user already approved an execution plan, use it as context instead of inventing a competing outline.
