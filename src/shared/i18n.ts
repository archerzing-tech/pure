...
const translations: Record<Language, Record<string, string>> = {
  'zh-CN': {
    ...
    'diagram.imageLoadFailed': 'PlantUML 需要联网渲染（走 plantuml.com），现在连不上。回我一声，我改用 mermaid 重画——mermaid 在本地渲染，断网也能出图。',
  ...
  en: {
    ...
    'diagram.imageLoadFailed': 'PlantUML diagrams render online via plantuml.com, and that\'s unreachable right now. Ask me to redraw it with mermaid instead — mermaid renders locally and works offline.',
