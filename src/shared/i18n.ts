...
const translations: Record<Language, Record<string, string>> = {
  'zh-CN': {
    ...
    'llm.custom.addModel': '＋ 添加',
    'llm.custom.addModelTitle': '将输入框中的模型加入列表并设为默认',
  ...
  en: {
    ...
    'llm.custom.addModel': '+ Add',
    'llm.custom.addModelTitle': 'Add the model in the input above to the list and make it the default',
