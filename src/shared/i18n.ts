...
const translations: Record<Language, Record<string, string>> = {
  'zh-CN': {
    ...
    'llm.model.editorDefaultHint': '新对话优先使用此模型；点击列表项可切换',
    'llm.model.editorAddHint': '输入模型 ID，添加后会设为默认',
    'llm.model.editorListTitle': '模型列表',
    'llm.active': '当前使用',
    'llm.selected': '已选择',
    'llm.chooseCard': '选择',
    'llm.provider': '提供商',
    ...
    'llm.model': '模型',
    'llm.model.hint': '模型标识符（可添加多个，点击芯片设为默认）',
  ...
  en: {
    ...
    'llm.model.editorDefaultHint': 'New conversations start with this model; click a row to switch',
    'llm.model.editorAddHint': 'Enter a model ID; it becomes the default after adding',
    'llm.model.editorListTitle': 'Model list',
    'llm.active': 'Active',
    ...
    'llm.model': 'Model',
    'llm.model.hint': 'Model ID (add several; click a chip to make it the default)',
