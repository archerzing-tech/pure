...
const translations: Record<Language, Record<string, string>> = {
  'zh-CN': {
    ...
    'llm.custom.ollamaAdded': 'Ollama 预设已添加（模型可下方编辑）',
  ...
  en: {
    ...
    'artifacts.dblclickHint': 'Double-click to open',
    ...
    'llm.custom.ollama': '⚡ Ollama one-click preset',
    ...
    'llm.custom.ollamaAdded': 'Ollama preset added (models editable below)',
