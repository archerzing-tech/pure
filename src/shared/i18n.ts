...
const translations: Record<Language, Record<string, string>> = {
  'zh-CN': {
    ...
    'mcp.tools.probeHint': '「查看工具」会临时启动一次服务器进程、取完列表就关掉；第一次跑 npx 之类的命令可能要多等一会儿。',
  ...
  en: {
    ...
    'mcp.tools.probeHint': '"List tools" briefly starts the server process and shuts it down after reading the list; a first npx run may take a while.',
