...
const translations: Record<Language, Record<string, string>> = {
  'zh-CN': {
    ...
    'nav.schedules': '定时任务',
    'usage.title': '用量统计',
    'usage.desc': '跨会话的用量与行为画像（由本地会话统计聚合）',
    'usage.sessions': '会话数',
    'usage.turns': '总轮次',
    'usage.cost': '总成本',
    'usage.commandRate': '命令成功率',
    'usage.input': '输入',
    'usage.output': '输出',
    'usage.fileWrites': '文件写入',
    'usage.providers': 'Provider 分布',
    'usage.topCommands': '常用命令',
    'usage.activity': '近 14 天活动',
    'usage.sessionUnit': '会话',
    'usage.noData': '暂无数据',
    'schedule.title': '定时任务',
    ...
    'stats.windowUsed': '已用',
    'stats.windowRemaining': '剩余',
    'stats.tokenDist': 'Token 分布',
    'stats.noUsage': '暂无用量数据',
    'optimize.title': '优化建议',
    ...
    'queue.title': '任务队列',
    'queue.close': '关闭队列面板',
    'queue.inputPlaceholder': '一行一个任务（换行分隔），Ctrl/⌘+Enter 或点「添加」入队',
    'queue.add': '添加',
    'queue.empty': '队列为空',
    'queue.cancel': '取消该任务',
  ...
  en: {
    ...
    'usage.title': 'Usage',
    'usage.desc': 'Cross-session usage & behavior profile (aggregated from local session stats)',
    'usage.sessions': 'Sessions',
    'usage.turns': 'Total turns',
    'usage.cost': 'Total cost',
    'usage.commandRate': 'Command success',
    'usage.input': 'Input',
    'usage.output': 'Output',
    'usage.fileWrites': 'File writes',
    'usage.providers': 'Providers',
    'usage.topCommands': 'Top commands',
    'usage.activity': 'Last 14 days',
    'usage.sessionUnit': 'sessions',
    ...
    'stats.windowRemaining': 'Remaining',
    'stats.tokenDist': 'Token distribution',
    'stats.noUsage': 'No usage data yet',
    ...
    'queue.close': 'Close queue panel',
    'queue.inputPlaceholder': 'One task per line; Ctrl/⌘+Enter or “Add” enqueues',
    'queue.add': 'Add',
