...
const translations: Record<Language, Record<string, string>> = {
  'zh-CN': {
    ...
    'map.tileFallback': '底图加载失败（网络受限）— 已显示无底图的路线示意，点击“刷新地图”可重试',
    ...
    'llm.reasoning.label': '思考深度（reasoning effort）',
    'llm.reasoning.hint': '只对支持 reasoning 的模型生效，随请求发送 reasoning_effort 参数',
    'llm.reasoning.low': '低',
    'llm.reasoning.medium': '中',
    'llm.reasoning.high': '高',
    'llm.reasoning.supported': '当前模型支持 reasoning，会随请求发送',
    'llm.reasoning.unsupported': '当前模型不在已知 2026+ 清单，默认不发送',
    'llm.reasoning.forcedOn': '已手动强制支持，覆盖模型清单判断',
    'llm.reasoning.forcedOff': '已手动强制不发送，覆盖模型清单判断',
    'llm.reasoning.anthropic': 'anthropic 协议端点暂不发送该参数',
    'llm.reasoning.override.auto': '自动',
    'llm.reasoning.override.on': '强制支持',
    'llm.reasoning.override.off': '强制不支持',
  ...
  en: {
    ...
    'map.tileFallback': 'Basemap unavailable (network) — showing a schematic route without tiles. Click “Refresh map” to retry.',
    ...
    'llm.reasoning.label': 'Reasoning effort',
    'llm.reasoning.hint': 'Sent as reasoning_effort, and only to models that support it',
    'llm.reasoning.low': 'Low',
    'llm.reasoning.medium': 'Medium',
    'llm.reasoning.high': 'High',
    'llm.reasoning.supported': 'This model supports reasoning — reasoning_effort is sent',
    'llm.reasoning.unsupported': 'This model is not on the known 2026+ list — nothing is sent',
    'llm.reasoning.forcedOn': 'Forced on, overriding the model-name detection',
    'llm.reasoning.forcedOff': 'Forced off, overriding the model-name detection',
    'llm.reasoning.anthropic': 'not sent to anthropic-protocol endpoints yet',
    'llm.reasoning.override.auto': 'Auto',
    'llm.reasoning.override.on': 'Force on',
    'llm.reasoning.override.off': 'Force off',
