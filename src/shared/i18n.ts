...
const translations: Record<Language, Record<string, string>> = {
  'zh-CN': {
    ...
    'llm.budget.defaults': 'Token 上限',
    'llm.budget.context': '最大上下文',
    'llm.budget.output': '最大输出',
    'llm.budget.auto': '自动',
    'llm.budget.hint': '留空使用供应商/模型默认值',
    'llm.budget.contextShort': '上下文',
    'llm.budget.outputShort': '输出',
  ...
  en: {
    ...
    'llm.model.testErr': '✗ {err}',
    'llm.budget.defaults': 'Token limits',
    'llm.budget.context': 'Max context',
    'llm.budget.output': 'Max output',
    'llm.budget.auto': 'Auto',
    'llm.budget.hint': 'Leave blank to use the provider/model default',
    'llm.budget.contextShort': 'Context',
    'llm.budget.outputShort': 'Output',
